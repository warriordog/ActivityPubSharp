...
public class JsonLDContextPropertyConverterTests : JsonConverterTests<HashSet<JsonLDContext>, JsonLDContextPropertyConverter>
{
    protected override JsonLDContextPropertyConverter ConverterUnderTest { get; set; } = new();

    public class ReadShould : JsonLDContextPropertyConverterTests
    {
    ...
    public class WriteShould : JsonLDContextPropertyConverterTests
    {
        [Fact]
        public void WriteSingleDirectly()
        {
            var input = new HashSet<JsonLDContext>
            {
